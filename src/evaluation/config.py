...
class EvaluationSettings:
    ...
    # Precision thresholds (LLM-as-judge)
    precision_at_5_threshold: float = 0.75
    precision_at_10_threshold: float = 0.70

    # Legacy recall thresholds (kept for backward compatibility)
...
def get_settings() -> EvaluationSettings:
    ...
    return EvaluationSettings(
        ...
        precision_at_5_threshold=float(os.getenv("EVAL_PRECISION_5_THRESHOLD", "0.75")),
        precision_at_10_threshold=float(os.getenv("EVAL_PRECISION_10_THRESHOLD", "0.70")),
